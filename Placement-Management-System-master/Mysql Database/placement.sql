...
INSERT IGNORE INTO `applied` (`aid`, `jid`, `cid`, `sid`, `iseligible`) VALUES
(89, 101, 5, 210, 'yes'),
(90, 101, 5, 211, 'no'),
(91, 99, 5, 210, 'yes'),
(92, 99, 5, 207, 'no'),
...
CREATE TABLE IF NOT EXISTS `tpo` (
  ...
  `tname` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `temail` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `tpassword` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `collegename` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `city` varchar(50) NOT NULL,
  `mobileno` decimal(10,0) NOT NULL,
  `website` varchar(50) NOT NULL,
  `nirf` decimal(3,0) NOT NULL,
  `nacc` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ncte` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `aicte` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ugc` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`tid`)
